...
public class WebDriverUtility {
	...
	public static void waitForButtonToClickable(WebDriver driver, WebElement element) {
	 ...
	 */
	public static void switchToWindow(WebDriver driver, String titleOfPageToSwitch) {
	 ...
	 * @param driver
	 */
	public static void selectCancelInAlertPopUp(WebDriver driver) {
